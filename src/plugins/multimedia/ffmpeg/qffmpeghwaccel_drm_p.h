...
#ifndef QFFMPEGHWACCEL_DRM_P_H
#define QFFMPEGHWACCEL_DRM_P_H
...
class DRMTextureConverter : public TextureConverterBackend
{
public:
    DRMTextureConverter(QRhi *rhi);
    ~DRMTextureConverter() override;
