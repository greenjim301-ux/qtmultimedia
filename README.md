...
### Key Modifications
*   **DRM Render Support**: Implemented DRM frame render support specifically for FFmpeg Rockchip MPP decoded AVFrame, with new files `src/plugins/multimedia/ffmpeg/qffmpeghwaccel_drm.cpp` and `src/plugins/multimedia/ffmpeg/qffmpeghwaccel_drm_p.h`.
